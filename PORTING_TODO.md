...
- [x] Implement settings persistence ✅
  - [x] Choose INI library (SimpleIni - header-only) ✅
  - [x] Implement InitSettings(), GetSetting(), SetSetting(), GetFlag() ✅
  - [x] Create settings file on first save (auto-save on change) ✅
  - [x] Load settings on startup ✅
  - [x] Settings stored alongside executable (settings.ini) for portable distribution ✅
- [x] Graphics settings ✅
  - [x] Fullscreen mode saved and restored ✅
- [x] Audio settings ✅
  - [x] Music volume saved and restored ✅
  - [x] Sound pack selection (BBC/C64/Spectrum/Amiga) saved and restored ✅
  - [x] Music enable/disable saved and restored ✅
  - [x] Tunes enable/disable saved and restored ✅
- [x] Landscape settings ✅
  - [x] Remember last played landscape ✅
  - [x] Remember all played landscapes (codes stored in [Landscapes] section) ✅

### 4.3: Game State & Progression ✅

- [x] Test all game states ✅
  - [x] Title screen → Landscape preview transition
  - [x] Landscape preview → Game start
  - [x] Game → Sky view (Q key)
  - [x] Game → Level complete
  - [x] Level complete → Next level
- [x] Test win/lose conditions ✅
  - [x] Win: Absorb sentinel and transfer to its pedestal
  - [x] Lose: Absorbed by sentinel/sentry/meanie
  - [x] Proper game over screen displays on defeat
  - [x] Game over screen shows correct information
  - [x] Can exit or restart from game over screen
- [x] Test settings are saved/loaded correctly ✅
  - [x] Graphics settings persist between sessions (fullscreen) ✅
  - [x] Audio settings persist between sessions (music, tunes, volume, sound pack) ✅
  - [x] All played landscapes remembered with last played selected by default ✅
...
- [x] Full gameplay testing (3+ levels)
- [x] Edge case testing (rapid inputs, animations, focus loss)
- [x] Performance verification (memory leaks, long sessions)
...
- [x] Play through 3+ levels completely
- [x] Test all object types (trees, boulders, robots)
- [x] Test absorption and creation extensively
- [x] Verify energy system works correctly
- [x] Test rapid key presses
- [x] Test creating/absorbing while animations active
- [x] Test window resize during gameplay
- [x] Test alt-tab / focus loss behavior
...
**Settings:** Using SimpleIni (header-only INI library) ✅
**Audio:** Using SDL2_mixer with spatial audio (stereo panning + distance attenuation) ✅
